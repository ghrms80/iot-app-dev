...
#define WIFI_AP_BEACON_INTERVAL 100      // AP beacon: 100ms recommanded
#define WIFI_AP_IP "192.168.0.1"         // AP default IP
#define WIFI_AP_GATEWAY "192.168.0.1"    // AP default Gateway
                                         // (should be the same as the IP)
#define WIFI_AP_NETMASK "255.255.255.0"  // AP network
#define WIFI_AP_BANDWIDTH WIFI_BW_HT20   // AP bandwidth 20 MHz
                                         // (40 MHz is the other option)
#define WIFI_STA_POWER_SAVE WIFI_PS_NONE // Power save not used
#define MAX_SSID_LENGTH 32               // IEEE standard maximun
#define MAX_PASSWORD_LENGTH 64           // IEEE standard maximun
 ...
 * e.g. how you've expanded the wifi_app_queue_message_t.
 */
