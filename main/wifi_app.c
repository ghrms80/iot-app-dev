 ...
 * @param arg 호출시 핸들러에 전달되는 데이터
 * @param event_base 핸들러를 등록할 이벤트의 기본 ID
 * @param event_id 핸들러를 등록할 이벤트의 ID
 ...
 */
static void wifi_app_soft_app_config(void)
{
    ...
    // Assign access point's static IP, GW, Netmask
    ...
    // (for connecting stations e.g. your mobile device)
